      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white shadow-lg rounded-2xl p-6">
          ...
          <p className="text-gray-700 mb-4">
            Halo, <span className="font-semibold text-black">{user.email}</span> 👋
          </p>

          <div className="mt-6 flex justify-between items-center">
            <p className="text-gray-600">
              Kelola produk dan program pelatihan UMKM Anda melalui platform ini.
            </p>
            <button
              onClick={handleLogout}
              className="bg-red-500 hover:bg-red-600 transition text-white font-semibold px-4 py-2 rounded-lg shadow-md"
            >
              Logout
            </button>
          </div>
        ...
        <div className="mt-8">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl text-black font-bold">📦 Produk Saya</h2>
          ...
          {products.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {products.map((product) => (
                <div key={product._id} className="bg-white p-4 rounded-xl shadow-md space-y-2">
                  {product.gambar && (
